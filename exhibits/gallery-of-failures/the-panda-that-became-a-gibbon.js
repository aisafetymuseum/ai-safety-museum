/* Exhibit: The Panda That Became a Gibbon
   Hall: The Gallery of Failures
   Map character: O  (see content/map.js)
   New exhibit? See CONTRIBUTING.md */
EXHIBIT("O", {
  wing: "fail",
  t: "The Panda That Became a Gibbon",
  obj: "Two identical photographs of a giant panda. The right one is labeled GIBBON, 99.3% CONFIDENCE.",
  body: [
